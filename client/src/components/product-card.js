                ...
                <Box sx={{ '& > *': { margin: 0, padding: 0 } }}>
                    {product.distance != "progresiv" && (
                        <>
                            ...
                            />
                            <CardSlider
                                name="thicknessReduction-slider"
                                title="MAI SUBTIRE"
                                value={product.thicknessReduction}
                                onChange={handleSliderChange}
                                min={0}
                                max={100}
                                step={20}
                            ...
                            <CardSlider
                                name="heliomat-slider"
                                title="INCHIDERE"
                                value={product.heliomat}
                                onChange={handleSliderChange}
                                min={0}
                                max={100}
                                step={20}
                    ...
                    {product.distance === "progresiv" && (
                        <>
                            <CardSlider
                                ...
                                title="DISTANTA"
                                value={product.distanceAttribute}
                                onChange={handleSliderChange}
                                min={0}
                                max={100}
                                step={20}
                            />
                            <CardSlider
                                name="intermediar-slider"
                                title="INTERMEDIAR"
                                value={product.intermediarAttribute}
                                onChange={handleSliderChange}
                                min={0}
                                max={100}
                                step={20}
                            ...
                            <div style={{ marginTop: '10px', marginBottom: '10px' }}><span style={{ color: '#888888' }}>EXPERIENȚĂ VIZUALĂ</span> </div>
                            <>
                                <CardSlider
                                    name="comfort-slider"
                                    title="CONFORT"
                                ...
                                />
                                <CardSlider
                                    name="focalization-slider"
                                    title="FOCALIZARE"
                                    value={product.focalization}
                                    onChange={handleSliderChange}
                                    min={0}
                                    max={100}
                                    step={20}
